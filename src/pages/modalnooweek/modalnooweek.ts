...
@IonicPage()
@Component({
  selector: 'page-modalnooweek',
  templateUrl: 'modalnooweek.html',
})
export class ModalnooweekPage {

  sendAbsenData = {"cabangid":""};
  resposeDetailAbsenOn:any;
  dataDetailAbsenOn1:any;
  constructor( public modalsNooWeek: ModalsNooWeek,
  ...
  sendata(){
    ...
    this.modalsNooWeek.postData(this.sendAbsenData).then((result) =>{
