...
@IonicPage()
@Component({
  selector: 'page-modalcollecttoday',
  templateUrl: 'modalcollecttoday.html',
})
export class ModalcollecttodayPage {

  sendAbsenData = {"cabangid":""};
  resposeDetailAbsenOn:any;
  dataDetailAbsenOn1:any;
  constructor( public modalsCollectToday: ModalsCollectToday,
  ...
  sendata(){
    ...
    this.modalsCollectToday.postData(this.sendAbsenData).then((result) =>{
